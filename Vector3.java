public class Vector3
{
	...
	/***refract function***/
	public Vector3 refract(Vector3 _normal, double _index1, double _index2)
	{
		double scale = dot(_normal);
		scale += Math.sqrt(_index1 * _index1 - _index2 * _index2 + scale * scale);
		return subtract(_normal.scale(scale));
	}
	public static Vector3 refract(Vector3 _vector, Vector3 _normal, double _index1, double _index2)
	{
